...
main( int argc, char *argv[ ] )
{
	...
	fprintf( stderr, "NonSimdM %10.2lf\t", megaMults );
	...
	fprintf( stderr, "SimdM %10.2lf\t", megaMults );
	...
	fprintf( stderr, "NonSimdMS %10.2lf\t", megaMultAdds );
	mmn = megaMultAdds;
	...
	fprintf( stderr, "SimdMS %10.2lf\t", megaMultAdds );
	mms = megaMultAdds;
	speedup = mms/mmn;
	fprintf( stderr, "(%6.2lf)\n", speedup );
	fprintf( stderr, "[ %8.1lf , %8.1lf , %8.1lf ]\n", C[ARRAYSIZE-1], sumn, sums );
