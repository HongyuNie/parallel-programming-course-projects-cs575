...
Spring 2022
Project 6
Part 3: OpenCL Array Multiply + Reduction
********************************************************/
...
#define KERN_FUNC			"ArrayMultReduce"
...
********************************************/
	...
	status = clSetKernelArg( kernel, 2, LOCAL_SIZE * sizeof(float), NULL ); //This NULL is how you tell OpenCL that this is a local(shared) array, not a global array
	if( status != CL_SUCCESS )
...
// *************************************************************/
	...
	fprintf( stderr, "%4d\t%4d\t%10.3lf MegaMultiply-Reductions Per Second\n",
